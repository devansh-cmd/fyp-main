...
\chapter*{Statement on the Use of Generative AI Tools}
\addcontentsline{toc}{chapter}{Statement on the Use of Generative AI Tools}

I used a generative AI tool in a limited and permitted support role during the preparation of this project. The tool was not used to generate original technical content, source code, experimental results, data analysis, or conclusions presented in this report.

\section*{AI Tool Used}

\textbf{Name:} ChatGPT \\
\textbf{Provider:} OpenAI \\
\textbf{Version:} GPT-4 / GPT-5 (where applicable) \\
\textbf{URL:} \url{https://chat.openai.com} \\
\textbf{Accessed:} Multiple dates between October 2024 and March 2025
...
All model architectures, training pipelines, code implementations, experimental design, hyperparameter choices, evaluation procedures, results, and analysis were developed and written by me. 
...
I confirm that the use of generative AI tools in this project complies fully with the School’s policy on the responsible use of AI, and that this submission represents my own independent work.
