...
def main():  # Actual main training function
    ...
    # model setup - ResNet50 with CBAM
    ...
    best_val_acc = 0.0
    best_ckpt = tb_logdir / "resnet50_cbam_best.pt"
    ...
    with open(tb_logdir / f"resnet50_cbam_metrics_e{args.epochs}.json", "w") as f:
    ...
    with open(tb_logdir / f"resnet50_cbam_summary_e{args.epochs}.json", "w") as f:
