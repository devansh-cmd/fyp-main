...
L.~Aversano, M.~L. Bernardi, M.~Cimitile, and R.~Pecori, ``Deep neural networks for Parkinson's disease detection from mel-spectrogram representations of vowels and phrases,'' in \textit{Proc. IEEE Int. Joint Conf. Neural Netw. (IJCNN)}, 2022.
