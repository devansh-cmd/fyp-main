...
On the Italian PD corpus, our proposed model achieves a mean macro F1 of 0.964, compared with 0.971 reported by Aversano et al.~\cite{aversano2024} and 0.987 reported by Bandini et al.~\cite{bandini2023}. The remaining gap is less than one percentage point.
